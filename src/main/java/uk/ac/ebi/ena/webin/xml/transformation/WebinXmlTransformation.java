...
/**
 * Creates and returns transformer for every object type. The returned transformer objects are
 * thread-safe.
 */
public class WebinXmlTransformation {

  private static String STUDY_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/study.xslt";
  private static String PROJECT_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/project.xslt";
  private static String SAMPLE_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/sample.xslt";
  private static String EXPERIMENT_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/experiment.xslt";
  private static String RUN_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/run.xslt";
  private static String ANALYSIS_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/analysis.xslt";
  private static String EGA_DAC_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/ega-dac.xslt";
  private static String EGA_POLICY_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/ega-policy.xslt";
  private static String EGA_DATASET_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/ega-dataset.xslt";
  private static String SUBMISSION_TEMPLATE_CLASSPATH_URL =
      "/uk/ac/ebi/ena/webin/xml/transformation/xslt/submission.xslt";

  private static TemplateProvider templateProvider =
      new CachedTemplateProvider(
          new ClasspathLoadedTemplateProvider(
