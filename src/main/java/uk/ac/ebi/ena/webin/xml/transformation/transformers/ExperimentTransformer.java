    ...
    public Document transform(Document document) throws WebinXmlTransformationException {
        try {
            ...
            for (Node libraryDescriptor :
                getXmlNodes(
                    document, "/EXPERIMENT_SET/EXPERIMENT/DESIGN/LIBRARY_DESCRIPTOR[not(LIBRARY_STRATEGY)]")) {
            ...
            throw new WebinXmlTransformationException("Unexpected error while transforming experiment xml.", e);
        }
    }
